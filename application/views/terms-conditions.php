                    ...
                    <div class="services__details-left">
                        ...
                        <div class="services__details-left-content">
                           ...
                           <h3 class="mb-30">User Conduct</h3>
                            <p class="mb-25">You agree to use our Website only for lawful purposes and in a manner that does not infringe or restrict the rights of others. Prohibited activities include but are not limited to:</p>
                            <div class="services__details-left-content-list bold">
                                <div class="row">
                                    <div>
                                        <span><i class="far fa-check"></i>Uploading, transmitting, or sharing any content that is unlawful, harmful, obscene, or infringing upon intellectual property rights.</span>
                                        <span><i class="far fa-check"></i>Engaging in any activity that disrupts or interferes with the functioning of our Website or its servers. </span>
                                        <span><i class="far fa-check"></i> Attempting to gain unauthorized access to any part of our Website or other users' accounts.</span>
                                        <span><i class="far fa-check"></i>Impersonating another person or entity, or providing false information.</span>
                           ...
                           <h3 class="mb-30">Third-Party Links</h3>
                            <p class="mb-25">Our Website may contain links to third-party websites or services that are not owned or controlled by [Company Name]. We do not endorse or assume any responsibility for the content, privacy policies, or practices of third-party websites. You access these links at your own risk and should review their terms and conditions and privacy policies.</p>

                           <h3 class="mb-30">Disclaimer of Warranties</h3>
                           ...
                           <h3 class="mb-30">Severability</h3>
                            <p class="mb-25">If any provision of this Agreement is held to be invalid, illegal, or unenforceable, the remaining provisions shall continue in full force and effect.</p>
                           <h3 class="mb-30">Changes to the Agreement</h3>
                            <p class="mb-25">We reserve the right to modify or update this Agreement at any time. Any changes will be posted on this page with the updated "Effective Date."</p>
